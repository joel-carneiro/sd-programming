...
public class GamePanel extends JPanel implements ActionListener {
	...
	static final int GAME_UNITS = (SCREEN_HEIGTH * SCREEN_HEIGTH) / UNIT_SIZE;
		...
		if (running) {
			...
			*/
			...
			for (int i = 0; i < bodyParts; i++) {
				...
				g.drawString("Apples: " + applesEaten,
						(SCREEN_WIDTH - metrics.stringWidth("Apples: " + applesEaten))/2,
						g.getFont().getSize()); 
	...
	public void gameOver(Graphics g) {
		...
		FontMetrics metrics = getFontMetrics(g.getFont());
		g.drawString("Gamer Over", (SCREEN_WIDTH - metrics.stringWidth("Gamer Over"))/2, SCREEN_HEIGTH/2); 
	}
